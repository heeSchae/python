...
#Add your code here!
def to_dictionaries(alist):
    mydictionary = {}
    for item in alist:
        mydictionary[item.short_name] = {"long_name": item.long_name, "iso_code": item.iso_code, "iso_short": item.iso_short, "iso_long": item.iso_long, "capital": item.capital}
    return mydictionary
