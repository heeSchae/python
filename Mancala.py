...
def check_winner(twoLists):
    first = {}
    second = {}
    
    for i in range(1, 8):
        first[str(i)] = twoLists[0][i-1]
        second[str(i)] = twoLists[1][i-1]
    
    if first['2'] + first['3'] + first['4'] + first['5'] + first['6'] + first['7'] > 0\
    or second['1'] + second['2'] + second['3'] + second['4'] + second['5'] + second['6'] > 0:
        return("Keep playing!")
        
    elif first['1'] > second['7']:
        return("Player 1 wins!")
