...
def tire_pressure(integers):
    newList = []
    for pressure in integers:
        if pressure >= 15 and pressure <= 55:
            newList.append(pressure)
    last = newList[-5:]
    total = 0
    for item in last:
        total += item
...
#print: 35.0
a_list = [35, 35, 37, 61, 35, 35, 1, 33, 33, 33, 33, 33, 32, 32, 32, 61, 32, 64, 32, 32, 32, 32, 34, 34, 36, 71, 37, 39]
